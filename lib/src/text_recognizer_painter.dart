...
class TextRecognizerPainter extends CustomPainter {
  ...
  void paint(
    ...
    var siz = getRatioHeight(
      rotation,
      size,
      absoluteImageSize,
    );
    var siz1 = getRatioWidth(
      rotation,
      size,
      absoluteImageSize,
    );

    var currentScannerBoxWidth = boxWidth / siz1;
    var currentScannerBoxHeight = boxHeight / siz;
    var currentXOffset = offset.dx * siz1;
    var currentYOffset = offset.dy * siz;

    var boxLeft = translateX(
      (currentScannerBoxWidth / boxLeftOff) + currentXOffset,
      rotation,
      size,
      absoluteImageSize,
    );
    var boxTop = translateY(
      (currentScannerBoxHeight / boxTopOff) + currentYOffset,
      rotation,
      size,
      absoluteImageSize,
    );
    var boxRight = translateX(
